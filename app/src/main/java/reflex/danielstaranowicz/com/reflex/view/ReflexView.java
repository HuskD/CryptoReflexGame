package reflex.danielstaranowicz.com.reflex.view;
...
import reflex.danielstaranowicz.com.reflex.R;

/**
 * Created by danie on 18.01.2018.
 */
...
public class ReflexView extends View {
    ...
    //Collections types for our coins and Animators
    ...
    private static final int INITIAL_ANIMATION_DURATION = 4400; // 6s
    public static final Random random = new Random();
    public static final int SPOT_DIAMETER = 180;
    ...
    public static final int LEVEL_UP_SOUND_ID = 4;
    public static final int GAME_OVER_SOUND_ID = 5;
    ...
    // cancel animations and remove ImageViews representing coins
    private void cancelAnimations()
    {
        ...
        // remove remaining coins from the screen
    ...
    public void resetGame() {
        ...
        spots.clear(); // empty the List of coins
        animators.clear(); // empty the List of Animators
        livesLinearLayout.removeAllViews(); // clear old lives from screen

        int animationTimeRandom = random.nextInt(2000);

        animationTime = INITIAL_ANIMATION_DURATION + animationTimeRandom; // init animation length
    ...
    private void initializeSoundEffects(Context context) {
        ...
        soundMap.put(LEVEL_UP_SOUND_ID, soundPool.load(context, R.raw.levelup, SOUND_PRIORITY));
        soundMap.put(GAME_OVER_SOUND_ID, soundPool.load(context, R.raw.haha, SOUND_PRIORITY));
    ...
    public void addNewSpot()
    {
        ...
        int randomDiameterChanger = random.nextInt(80);
        spot.setLayoutParams(new RelativeLayout.LayoutParams(
                SPOT_DIAMETER + randomDiameterChanger, SPOT_DIAMETER + randomDiameterChanger));

        int randomImageNumber = random.nextInt(4);
        switch (randomImageNumber)  {
            case 0:
                spot.setImageResource(R.drawable.ltc);
                break;
            case 1:
                spot.setImageResource(R.drawable.ic_btc);
                break;
            case 2:
                spot.setImageResource(R.drawable.ic_eth);
                break;
            case 3:
                spot.setImageResource(R.drawable.monero);
                break;
        }

        //spot.setImageResource(random.nextInt(2) == 0 ?
          //      R.drawable.ltc : R.drawable.btc);
    ...
    // called when the user touches the screen, but not a Crypto
    @Override
    ...
    private void touchedSpot(ImageView spot)
    {
        ...
        if (spotsTouched % NEW_LEVEL == 0) {
            ...
            //set random bg depending on a level


            soundPool.play(LEVEL_UP_SOUND_ID, volume, volume, SOUND_PRIORITY, 0, 1.0F);

            int randomBg = random.nextInt(15);
            switch (randomBg) {
                case 0:
                    relativeLayout.setBackgroundResource(R.drawable.myk);
                    break;
                case 1:
                    relativeLayout.setBackgroundResource(R.drawable.stock2);
                    break;
                case 2:
                    relativeLayout.setBackgroundResource(R.color.bgColor_6);
                    break;
                case 3:
                    relativeLayout.setBackgroundResource(R.drawable.stock3);
                    break;
                case 4:
                    relativeLayout.setBackgroundResource(R.drawable.bchain);
                    break;
                case 5:
                    relativeLayout.setBackgroundResource(R.color.bgColor);
                    break;
                case 6:
                    relativeLayout.setBackgroundResource(R.drawable.frank);
                    break;
                case 7:
                    relativeLayout.setBackgroundResource(R.drawable.credit);
                    break;
                case 8:
                    relativeLayout.setBackgroundResource(R.drawable.btcbg);
                    break;
                case 9:
                    relativeLayout.setBackgroundResource(R.color.bgColor_7);
                    break;
                case 10:
                    relativeLayout.setBackgroundResource(R.color.bgColor_1);
                    break;
                case 11:
                    relativeLayout.setBackgroundResource(R.color.bgColor_2);
                    break;
                case 12:
                    relativeLayout.setBackgroundResource(R.color.bgColor_3);
                    break;
                case 13:
                    relativeLayout.setBackgroundResource(R.color.bgColor_4);
                    break;
                case 14:
                    relativeLayout.setBackgroundResource(R.color.bgColor_5);
                    break;
    ...
    public void missedSpot(ImageView spot)
    {
        ...
        if (livesLinearLayout.getChildCount() == 0) {
            ...
            soundPool.play(GAME_OVER_SOUND_ID, volume, volume, SOUND_PRIORITY, 0, 1.0F);
